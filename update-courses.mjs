...
const startPattern = '{/* Featured Math Tests Section */}';
const startIndex = content.indexOf(startPattern);
const endPattern = '      <section id="testlar"';
const endIndex = content.indexOf(endPattern);
// Find the closing tags just before endIndex
const realEndIndex = content.lastIndexOf('</section>', content.lastIndexOf('</section>', endIndex) - 1);
  ...
  const newCoursesSection = `
        ...
        <section className="mb-section-gap">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Course 1 */}
            <div className="group flex flex-col bg-surface-container-lowest dark:bg-surface-container-low rounded-3xl overflow-hidden border border-outline-variant/30 hover:border-primary/50 shadow-sm hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
            ...
            {/* Course 2 */}
            <div className="group flex flex-col bg-surface-container-lowest dark:bg-surface-container-low rounded-3xl overflow-hidden border border-outline-variant/30 hover:border-tertiary/50 shadow-sm hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              <div className="relative h-56 w-full overflow-hidden">
            ...
            {/* Course 3 */}
            <div className="group flex flex-col bg-surface-container-lowest dark:bg-surface-container-low rounded-3xl overflow-hidden border border-outline-variant/30 hover:border-secondary/50 shadow-sm hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              <div className="relative h-56 w-full overflow-hidden">
...
`;
  ...
  const newContent = content.substring(0, startIndex) + newCoursesSection + content.substring(endIndex);
  fs.writeFileSync('src/components/WelcomeScreen.tsx', newContent);
  console.log("Updated courses section successfully.");
} else {
